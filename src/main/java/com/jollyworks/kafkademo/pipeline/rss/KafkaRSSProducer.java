...
public class KafkaRSSProducer {
    ...
    public KafkaRSSProducer(KafkaTemplate<String, RssItem> rssKafkaTemplate)
    {
        this.kafkaTemplate = rssKafkaTemplate;
    }

    public void sendRoundRobinbMessageAsync(RssItem message) {
        // don't need to have the records go to the same partition
